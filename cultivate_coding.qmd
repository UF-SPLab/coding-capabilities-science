...
![](python.png)
XKCD^[https://xkcd.com/353/](https://xkcd.com/353/)
...
`mne_bids_pipeline --config=custom_config.py --steps=preprocessing,sensor`
...
# Data Science Skills Essential to Statistical Computation and Machine Learning

## Statisical models & Data Visualizations {.smaller}
...
![](GofG_wilkinson.png)
Wilkinson, L., & Wilkinson, L. (1987). Systat: The System for Statistics for the MacIntosh. Systat.
...
![](GofG_aesth.png)
Wilkinson, L. (2012). The Grammar of Graphics. In: Gentle, J., Härdle, W., Mori, Y. (eds) Handbook of Computational Statistics. Springer Handbooks of Computational Statistics. Springer, Berlin, Heidelberg. https://doi.org/10.1007/978-3-642-21551-3_13
...
Doing data manipulations with than 2 variables in a table can be cognitively taxing. 
...
> Programs must be written for humans to read, and only incidentally for computers to execute.^[Abelson, H., Sussman, G. J. 1985. Structure and Interpretation of Computer Programs. Cambridge, MA: MIT Press. p.xxiv]  
...
- Model Evaluation and Iteration: 
   -After training models, you'll need to evaluate their performance and possibly iterate over the modeling process.
...
![](simple_answers.png)
XKCD^[[https://xkcd.com/1289/](https://xkcd.com/1289/)]

Permanent link to this comic: https://xkcd.com/2730/
Image URL (for hotlinking/embedding): https://imgs.xkcd.com/comics/code_lifespan.png

Permanent link to this comic: https://xkcd.com/1833/
Image URL (for hotlinking/embedding): https://imgs.xkcd.com/comics/code_quality_3.png

Permanent link to this comic: https://xkcd.com/1597/
Image URL (for hotlinking/embedding): https://imgs.xkcd.com/comics/git.png

Permanent link to this comic: https://xkcd.com/1831/
Image URL (for hotlinking/embedding): https://imgs.xkcd.com/comics/here_to_help.png

Permanent link to this comic: https://xkcd.com/657/
Image URL (for hotlinking/embedding): https://imgs.xkcd.com/comics/movie_narrative_charts.png

Permanent link to this comic: https://xkcd.com/2048/
Image URL (for hotlinking/embedding): https://imgs.xkcd.com/comics/curve_fitting.png

Permanent link to this comic: https://xkcd.com/2701/
Image URL (for hotlinking/embedding): https://imgs.xkcd.com/comics/change_in_slope.png
