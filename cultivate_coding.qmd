...
![](reachability-example.png){.absolute top="20%" left="0" height="450"}
...
![](reachability-exampleE.jpg){.absolute top="20%" left="0" height="450"}



:::{.fragment fragment-index=2}

![](reachability-exampleK.jpg){.absolute top="20%" left="0" height="450"}



:::{.fragment fragment-index=3}

![](reachability-exampleH.jpg){.absolute top="20%" left="0" height="450"}
...
![](https://imgs.xkcd.com/comics/git.png){.absolute height=100% top=0% right=10%} 
...
![](https://imgs.xkcd.com/comics/change_in_slope.png){.absolute width=90% top=0% right=-5%} 
...
## Online Courses, Tutorials, Free Books! {.smaller}


::: columns
::: {.column width="20%"}

[![](r4ds-cover.jpg)](https://r4ds.hadley.nz/)

:::
::: {.column width="20%"}


[![](modern-dive-cover.png)](https://moderndive.com/)
:::

::: {.column width="20%"}

[![](hopr-cover.png)](https://rstudio-education.github.io/hopr/)

:::
::: {.column width="20%"}
[![](p4da-cover.jpeg)](https://wesmckinney.com/book/)
:::

::: {.column width="20%"}

[![](PDSH-cover.png)](https://jakevdp.github.io/PythonDataScienceHandbook/)
:::
:::
...
- Crump, M. J. C. (2020). Reproducible statistics for psychologists with R: Lab Tutorials. <https://doi.org/10.17605/OSF.IO/KBHGA>
...
[Setup VSCode](https://code.visualstudio.com/docs/copilot/overview)
...
:::
::: {.column width="33%"}
[Setup RStudio](https://docs.posit.co/ide/user/ide/guide/tools/copilot.html)
Autocomplete suggestions

1. simple/specific comment 
2. Copilot’s code suggestion 
3. Status(waiting/received/none)
...
## {.smaller background-image="chatGPT_bioinformatics_fig1a.png" background-size="45%" background-position="15% 2%" background-repeat="no-repeat"}
...
![](chatGPT_bioinformatics_fig1b.png){.absolute top=10% right=15% width=20%}
Rahman & Wong (2023)
...
[![](datacamp_chatgpt_cheatsheet.png){height=100px}](https://www.datacamp.com/cheat-sheet/chatgpt-cheat-sheet-data-science)[link](https://www.datacamp.com/cheat-sheet/chatgpt-cheat-sheet-data-science)
