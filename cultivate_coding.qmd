...
##### SPSS & Microsoft Office Workflow
...
##### Hybrid Workflow in Python (i.e., Jupyter Notebook)
...
##### Hybrid Workflow in Matlab (livescript)
...
graph LR
    A[Raw Data] --> B(RStudio)
    B -->|Process and </tab> </br> </br> </tab> Analyze| C(RStudio)
    C -->|Present and </tab> </br> </br> </tab> Document| D(RStudio)
